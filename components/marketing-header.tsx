...
//
// Sticky, but the dev-notice banner above it is not — the banner scrolls
// away and only this bar stays pinned, so a beta warning doesn't permanently
// eat vertical space on a page long enough to need a persistent nav.
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-5">
        ...
        {/* Plain <a>, not next/link: Link only scrolls to a fragment on a
            real route change, and these mostly target a hash on the current
            page. */}
